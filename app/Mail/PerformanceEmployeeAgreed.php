...
class PerformanceEmployeeAgreed extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: "Action Required — KPI Plan Awaiting Your Agreement: {$this->review->employee->name}",
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.performance.employee-agreed',
            with: [
