...
/**
* @see \App\Http\Controllers\HR\ResignationController::checklist
* @see app/Http/Controllers/HR/ResignationController.php:90
* @route '/hr/resignations/{resignation}/checklist'
*/
export const checklist = (args: { resignation: number | { id: number } } | [resignation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/hr/resignations/{resignation}/checklist'
*/
checklist.url = (args: { resignation: number | { id: number } } | [resignation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { resignation: args }
    }
...
* @route '/hr/resignations/{resignation}/checklist'
*/
checklist.post = (args: { resignation: number | { id: number } } | [resignation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: checklist.url(args, options),
    method: 'post',
})
...
* @route '/hr/resignations/{resignation}/checklist'
*/
const checklistForm = (args: { resignation: number | { id: number } } | [resignation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/hr/resignations/{resignation}/checklist'
*/
checklistForm.post = (args: { resignation: number | { id: number } } | [resignation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: checklist.url(args, options),
    method: 'post',
})
