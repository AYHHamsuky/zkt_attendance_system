...
* @route '/livewire-6cb207b1/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-6cb207b1/upload-file',
...
* @route '/livewire-6cb207b1/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-6cb207b1/preview-file/{filename}',
