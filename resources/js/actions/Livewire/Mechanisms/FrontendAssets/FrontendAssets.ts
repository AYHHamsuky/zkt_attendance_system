...
* @route '/livewire-6cb207b1/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-6cb207b1/livewire.js',
...
* @route '/livewire-6cb207b1/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-6cb207b1/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-6cb207b1/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-6cb207b1/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
