...
/**
* @see \App\Http\Controllers\HR\LeaveController::searchEmployees
* @see app/Http/Controllers/HR/LeaveController.php:163
* @route '/hr/employees/search'
*/
export const searchEmployees = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: searchEmployees.url(options),
    method: 'get',
})

searchEmployees.definition = {
    methods: ["get","head"],
...
* @route '/hr/employees/search'
*/
searchEmployees.url = (options?: RouteQueryOptions) => {
    return searchEmployees.definition.url + queryParams(options)
}
...
* @route '/hr/employees/search'
*/
searchEmployees.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: searchEmployees.url(options),
    method: 'get',
})
...
* @route '/hr/employees/search'
*/
searchEmployees.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: searchEmployees.url(options),
    method: 'head',
})
...
* @route '/hr/employees/search'
*/
const searchEmployeesForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: searchEmployees.url(options),
    method: 'get',
})
...
* @route '/hr/employees/search'
*/
searchEmployeesForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: searchEmployees.url(options),
    method: 'get',
})
...
* @route '/hr/employees/search'
*/
searchEmployeesForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: searchEmployees.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
searchEmployees.form = searchEmployeesForm
...
/**
* @see \App\Http\Controllers\HR\LeaveController::downloadDocument
* @see app/Http/Controllers/HR/LeaveController.php:326
* @route '/hr/leave/{leaveApplication}/document'
*/
export const downloadDocument = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/hr/leave/{leaveApplication}/document'
*/
downloadDocument.url = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { leaveApplication: args }
    }
...
* @route '/hr/leave/{leaveApplication}/document'
*/
downloadDocument.get = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: downloadDocument.url(args, options),
    method: 'get',
})
...
* @route '/hr/leave/{leaveApplication}/document'
*/
downloadDocument.head = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: downloadDocument.url(args, options),
    method: 'head',
})
...
* @route '/hr/leave/{leaveApplication}/document'
*/
const downloadDocumentForm = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/hr/leave/{leaveApplication}/document'
*/
downloadDocumentForm.get = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: downloadDocument.url(args, options),
    method: 'get',
})
...
* @route '/hr/leave/{leaveApplication}/document'
*/
downloadDocumentForm.head = (args: { leaveApplication: number | { id: number } } | [leaveApplication: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
const LeaveController = { daysPreview, searchEmployees, index, create, store, show, edit, update, destroy, lmApprove, lmReject, approve, reject, downloadDocument }
