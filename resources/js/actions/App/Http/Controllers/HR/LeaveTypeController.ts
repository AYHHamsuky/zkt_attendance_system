...
/**
* @see \App\Http\Controllers\HR\LeaveTypeController::index
* @see app/Http/Controllers/HR/LeaveTypeController.php:14
...
/**
* @see \App\Http\Controllers\HR\LeaveTypeController::create
* @see app/Http/Controllers/HR/LeaveTypeController.php:0
* @route '/hr/leave-types/create'
*/
...
/**
* @see \App\Http\Controllers\HR\LeaveTypeController::store
* @see app/Http/Controllers/HR/LeaveTypeController.php:23
* @route '/hr/leave-types'
*/
...
/**
* @see \App\Http\Controllers\HR\LeaveTypeController::edit
* @see app/Http/Controllers/HR/LeaveTypeController.php:0
* @route '/hr/leave-types/{leave_type}/edit'
*/
...
edit.definition = {
    methods: ["get","head"],
    url: '/hr/leave-types/{leave_type}/edit',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\HR\LeaveTypeController::update
* @see app/Http/Controllers/HR/LeaveTypeController.php:43
* @route '/hr/leave-types/{leave_type}'
*/
...
/**
* @see \App\Http\Controllers\HR\LeaveTypeController::destroy
* @see app/Http/Controllers/HR/LeaveTypeController.php:63
* @route '/hr/leave-types/{leave_type}'
*/
...
const LeaveTypeController = { index, create, store, edit, update, destroy }
